// منطق حساب التقنين للأراضي الصغيرة (القادسية والأمل وما شابه).
//
...
// الشرائح أدناه هي الشرائح اللي ظهرت فعليًا في قرعات سابقة (209، 276، 325، 350، 400، 450، 500)،
// وكلها معرّفة كثوابت قابلة للتعديل هنا تمهيدًا لنقلها للوحة إدارة لاحقًا.

export const PLOT_TIERS = [209, 276, 325, 350, 400, 450, 500] as const;
